...
void camlsnark_mnt4128_emplace_bits_of_field(std::vector<bool>* v, FieldT &x) {
...
std::vector<bool>* camlsnark_mnt4128_verification_key_other_to_bool_vector(
...
std::vector<FieldT>* camlsnark_mnt4128_verification_key_other_to_field_vector(
...
r1cs_ppzksnark_verification_key_variable<ppT>* camlsnark_mnt4128_r1cs_ppzksnark_verification_key_variable_create(
    protoboard<FieldT>* pb,
...
int camlsnark_mnt4128_r1cs_ppzksnark_verification_key_variable_size_in_bits_for_input_size(int input_size) {
  return r1cs_ppzksnark_verification_key_variable<ppT>::size_in_bits(input_size);
}

void camlsnark_mnt4128_r1cs_ppzksnark_verification_key_variable_delete(
    r1cs_ppzksnark_verification_key_variable<ppT>* vk) {
  delete vk;
}

void camlsnark_mnt4128_r1cs_ppzksnark_verification_key_variable_generate_r1cs_constraints(
    r1cs_ppzksnark_verification_key_variable<ppT>* vk) {
  vk->generate_r1cs_constraints(false);
}

void camlsnark_mnt4128_r1cs_ppzksnark_verification_key_variable_generate_r1cs_witness(
...
// proof
r1cs_ppzksnark_proof_variable<ppT>* camlsnark_mnt4128_r1cs_ppzksnark_proof_variable_create(
    protoboard<FieldT>* pb) {
  return new r1cs_ppzksnark_proof_variable<ppT>(*pb, "proof_variable");
}

void camlsnark_mnt4128_r1cs_ppzksnark_proof_variable_delete(
    r1cs_ppzksnark_proof_variable<ppT>* p) {
  delete p;
}

void camlsnark_mnt4128_r1cs_ppzksnark_proof_variable_generate_r1cs_constraints(
    r1cs_ppzksnark_proof_variable<ppT>* p) {
  p->generate_r1cs_constraints();
}

void camlsnark_mnt4128_r1cs_ppzksnark_proof_variable_generate_r1cs_witness(
...
// verifier
r1cs_ppzksnark_verifier_gadget<ppT>* camlsnark_mnt4128_r1cs_ppzksnark_verifier_gadget_create(
    protoboard<FieldT>* pb,
    r1cs_ppzksnark_verification_key_variable<ppT>* vk,
...
void camlsnark_mnt4128_r1cs_ppzksnark_verifier_gadget_delete(
    r1cs_ppzksnark_verifier_gadget<ppT>* g) {
  delete g;
}

void camlsnark_mnt4128_r1cs_ppzksnark_verifier_gadget_generate_r1cs_constraints(
    r1cs_ppzksnark_verifier_gadget<ppT>* g) {
  g->generate_r1cs_constraints();
}

void camlsnark_mnt4128_r1cs_ppzksnark_verifier_gadget_generate_r1cs_witness(
    r1cs_ppzksnark_verifier_gadget<ppT>* g) {
...
camlsnark_mnt4128_r1cs_se_ppzksnark_preprocessed_r1cs_se_ppzksnark_verification_key_variable_create_known(
    protoboard<FieldT>* pb,
...
r1cs_se_ppzksnark_preprocessed_r1cs_se_ppzksnark_verification_key_variable<ppT>* 
camlsnark_mnt4128_r1cs_se_ppzksnark_preprocessed_r1cs_se_ppzksnark_verification_key_variable_create()
{
  return new r1cs_se_ppzksnark_preprocessed_r1cs_se_ppzksnark_verification_key_variable<ppT>();
}

void
camlsnark_mnt4128_r1cs_se_ppzksnark_preprocessed_r1cs_se_ppzksnark_verification_key_variable_delete(
...
camlsnark_mnt4128_r1cs_se_ppzksnark_accumulated_verifier_gadget_create(
    protoboard<FieldT>* pb,
...
void camlsnark_mnt4128_r1cs_se_ppzksnark_accumulated_verifier_gadget_delete(
    r1cs_se_ppzksnark_accumulated_verifier_gadget<ppT>* g) {
  delete g;
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_accumulated_verifier_gadget_generate_r1cs_constraints(
    r1cs_se_ppzksnark_accumulated_verifier_gadget<ppT>* g) {
  g->generate_r1cs_constraints();
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_accumulated_verifier_gadget_generate_r1cs_witness(
    r1cs_se_ppzksnark_accumulated_verifier_gadget<ppT>* g) {
  g->generate_r1cs_witness();
}
...
camlsnark_mnt4128_r1cs_se_ppzksnark_accumulated_online_verifier_gadget_create(
    protoboard<FieldT>* pb,
    r1cs_se_ppzksnark_preprocessed_r1cs_se_ppzksnark_verification_key_variable<ppT>* vk,
    pb_variable<FieldT>* accX,
    pb_variable<FieldT>* accY,
...
void camlsnark_mnt4128_r1cs_se_ppzksnark_accumulated_online_verifier_gadget_delete(
    r1cs_se_ppzksnark_accumulated_online_verifier_gadget<ppT>* g) {
  delete g;
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_accumulated_online_verifier_gadget_generate_r1cs_constraints(
    r1cs_se_ppzksnark_accumulated_online_verifier_gadget<ppT>* g) {
  g->generate_r1cs_constraints();
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_accumulated_online_verifier_gadget_generate_r1cs_witness(
    r1cs_se_ppzksnark_accumulated_online_verifier_gadget<ppT>* g) {
  g->generate_r1cs_witness();
}

// proof
r1cs_se_ppzksnark_proof_variable<ppT>* camlsnark_mnt4128_r1cs_se_ppzksnark_proof_variable_create(
    protoboard<FieldT>* pb) {
  return new r1cs_se_ppzksnark_proof_variable<ppT>(*pb, "proof_variable");
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_proof_variable_delete(
    r1cs_se_ppzksnark_proof_variable<ppT>* p) {
  delete p;
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_proof_variable_generate_r1cs_constraints(
    r1cs_se_ppzksnark_proof_variable<ppT>* p) {
  p->generate_r1cs_constraints();
}

void camlsnark_mnt4128_r1cs_se_ppzksnark_proof_variable_generate_r1cs_witness(
...
camlsnark_mnt4128_r1cs_se_ppzksnark_verification_key_variable_create(
    protoboard<FieldT>* pb,
    int input_size)
{
...
void
camlsnark_mnt4128_r1cs_se_ppzksnark_verification_key_variable_delete(
...
void
camlsnark_mnt4128_r1cs_se_ppzksnark_verification_key_variable_generate_r1cs_witness(
    r1cs_se_ppzksnark_verification_key_variable<ppT>* vk,
...
camlsnark_mnt4128_r1cs_se_ppzksnark_verification_key_variable_characterizing_vars_up_to_sign(
    r1cs_se_ppzksnark_verification_key_variable<ppT>* vk
    )
{
...
std::vector<linear_combination<FieldT>>* 
camlsnark_mnt4128_r1cs_se_ppzksnark_verification_key_variable_sign_vars(
    r1cs_se_ppzksnark_verification_key_variable<ppT>* vk
    )
{
    std::vector<linear_combination<FieldT>>* res = new std::vector< linear_combination<FieldT> >();
...
camlsnark_mnt4128_gm_verification_key_other_query(
    r1cs_se_ppzksnark_verification_key<other_curve<ppT>> *vk)
{
...
std::vector< FieldT >*
camlsnark_mnt4128_gm_verification_key_characterizing_elts_up_to_sign(
    r1cs_se_ppzksnark_verification_key<other_curve<ppT>> *vk)
{
...
std::vector<FieldT>*
camlsnark_mnt4128_gm_verification_key_sign_elts(
    r1cs_se_ppzksnark_verification_key<other_curve<ppT>> *vk)
{
    std::vector<libff::G1<other_curve<ppT>>> all_G1_elts = {};
    all_G1_elts.emplace_back(vk->query[0]);
...
libff::G1<ppT>* camlsnark_mnt4128_g1_of_coords (libff::Fq<ppT>* x, libff::Fq<ppT>* y) {
  return new libff::G1<ppT>(*x, *y);
}

libff::G1<ppT>* camlsnark_mnt4128_g1_negate (libff::G1<ppT>* a) {
  return new libff::G1<ppT>(- *a);
}

libff::G1<ppT>* camlsnark_mnt4128_g1_double (libff::G1<ppT>* a) {
  return new libff::G1<ppT>(a->dbl());
}

libff::G1<ppT>* camlsnark_mnt4128_g1_add (libff::G1<ppT>* a, libff::G1<ppT>* b) {
  return new libff::G1<ppT>((*a) + (*b));
}

libff::G1<ppT>* camlsnark_mnt4128_g1_scale (libff::bigint<libff::mnt4128_r_limbs> *a, libff::G1<ppT>* x) {
  return new libff::G1<ppT>((*a) * (*x));
}

libff::G1<ppT>* camlsnark_mnt4128_g1_scale_field (FieldT *a, libff::G1<ppT>* x) {
  return new libff::G1<ppT>((*a) * (*x));
}

libff::G1<ppT>* camlsnark_mnt4128_g1_zero () {
  return new libff::G1<ppT>(libff::G1<ppT>::zero());
}

libff::G1<ppT>* camlsnark_mnt4128_g1_one () {
  return new libff::G1<ppT>(libff::G1<ppT>::one());
}

void camlsnark_mnt4128_g1_print(libff::G1<ppT>* x) {
  x->print();
}

bool camlsnark_mnt4128_g1_equal(libff::G1<ppT>* a, libff::G1<ppT>* b) {
  return *a == *b;
}

void camlsnark_mnt4128_g1_delete(libff::G1<ppT>* a) {
  delete a;
}

libff::G1<ppT>* camlsnark_mnt4128_g1_random() {
  return new libff::G1<ppT>(libff::G1<ppT>::random_element());
}

void camlsnark_mnt4128_g1_to_affine_coordinates(libff::G1<ppT>* a) {
  a->to_affine_coordinates();
}

libff::Fq<ppT>* camlsnark_mnt4128_g1_x(libff::G1<ppT>* a) {
  assert(a->Z() == libff::Fq<ppT>::one());
  return new libff::Fq<ppT>(a->X());
}

libff::Fq<ppT>* camlsnark_mnt4128_g1_y(libff::G1<ppT>* a) {
  assert(a->Z() == libff::Fq<ppT>::one());
  return new libff::Fq<ppT>(a->Y());
}

std::vector<libff::G1<ppT>>* camlsnark_mnt4128_g1_vector_create() {
  return new std::vector<libff::G1<ppT>>();
}

int camlsnark_mnt4128_g1_vector_length(std::vector<libff::G1<ppT>> *v) {
  return v->size();
}

void camlsnark_mnt4128_g1_vector_emplace_back(std::vector<libff::G1<ppT>>* v, libff::G1<ppT>* x) {
  v->emplace_back(*x);
}

libff::G1<ppT>* camlsnark_mnt4128_g1_vector_get(std::vector<libff::G1<ppT>>* v, int i) {
  libff::G1<ppT> res = (*v)[i];
  return new libff::G1<ppT>(res);
}

void camlsnark_mnt4128_g1_vector_delete(std::vector<libff::G1<ppT>>* v) {
  delete v;
}

void camlsnark_mnt4128_g2_delete(libff::G2<ppT>* a) {
  delete a;
}

void camlsnark_mnt4128_g2_to_affine_coordinates(libff::G2<ppT>* a) {
  a->to_affine_coordinates();
}

std::vector<libff::Fq<ppT>>* camlsnark_mnt4128_g2_x(libff::G2<ppT>* a) {
  assert(a->Z() == libff::Fqe<ppT>::one());
  return new std::vector< libff::Fq<ppT> >(a->X().all_base_field_elements());
}

std::vector<libff::Fq<ppT>>* camlsnark_mnt4128_g2_y(libff::G2<ppT>* a) {
  assert(a->Z() == libff::Fqe<ppT>::one());
